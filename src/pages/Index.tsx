  ...
  return (
    ...
    >
      <div className="min-h-screen">
        <Toaster />
        <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border draggable">
          <div className="py-4 px-6 max-w-screen-xl mx-auto flex justify-between items-center non-draggable">
